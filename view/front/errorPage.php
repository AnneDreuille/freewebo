...
<?php ob_start(); ?>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <p class="text-center bg-info rounded text-white py-3 h5">Oups ! vous vous êtes perdu(e).<br/> Pas de souci : vous pouvez revenir à la page d'accueil<br/> ou dans votre espace membre.</p>
            </div>
            <div class="col-md-3"></div>
        </div>
